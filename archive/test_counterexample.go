...
func main() {
	...
	fmt.Printf("optimization Objective: %d\n", response.optimizationMetrics.Objective)
	fmt.Printf("optimization Variables: %d\n", response.optimizationMetrics.VariableCount)
	fmt.Printf("optimization Constraints: %d\n", response.optimizationMetrics.ConstraintCount)
	fmt.Printf("optimization Solve time: %dms\n", response.optimizationMetrics.optimizationWallMs)
