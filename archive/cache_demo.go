...
func main() {
	...
	fmt.Printf("SMT Objective: %d\n", response1.SMTMetrics.Objective)
	fmt.Printf("SMT Variables: %d\n", response1.SMTMetrics.VariableCount) 
	fmt.Printf("SMT Constraints: %d\n", response1.SMTMetrics.ConstraintCount)
	fmt.Printf("SMT Solve time: %dms\n", response1.SMTMetrics.SMTWallMs)
	...
	fmt.Printf("SMT Objective: %d\n", response2.SMTMetrics.Objective)
	fmt.Printf("SMT Variables: %d\n", response2.SMTMetrics.VariableCount)
	fmt.Printf("SMT Constraints: %d\n", response2.SMTMetrics.ConstraintCount)
	fmt.Printf("SMT Solve time: %dms\n", response2.SMTMetrics.SMTWallMs)
