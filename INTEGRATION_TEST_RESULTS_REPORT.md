...
- optimization optimization functional (optimizer 4.15.2)
...
- Config must include complete optimization, weights, and other sections
...
- Default config must include optimization, weights, tokenizer sections
