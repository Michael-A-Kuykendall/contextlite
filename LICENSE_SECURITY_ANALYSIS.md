...
tfg.TrackQuery("optimization", duration, 100)  // Context queries
tfg.TrackError("connection", err)     // Error events
tfg.RequireFeature("advanced_optimization")    // Feature usage
```
...
GET /analytics?days=30
{
  ...
  "analytics": {
    ...
    "top_features": [
      ...
      {"feature": "optimization_optimization", "count": 8934}
    ]
  }
}
