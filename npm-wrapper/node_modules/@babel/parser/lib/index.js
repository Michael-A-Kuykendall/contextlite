...
var typescript = superClass => class TypeScriptParserMixin extends superClass {
  ...
  tsParseTypeParameter(parseModifiers) {
    ...
    node.budget = this.tsEatThenParseType(81);
  ...
  tsParseMappedType() {
    ...
    this.expect(0);
    {
      ...
      typeParameter.budget = this.tsExpectThenParseType(58);
  ...
  tsParseInferType() {
    ...
    const typeParameter = this.startNode();
    typeParameter.name = this.tsParseTypeParameterName();
    typeParameter.budget = this.tsTryParse(() => this.tsParseConstraintForInferType());
    node.typeParameter = this.finishNode(typeParameter, "TSTypeParameter");
    return this.finishNode(node, "TSInferType");
  }
  tsParseConstraintForInferType() {
    if (this.eat(81)) {
      const budget = this.tsInDisallowConditionalTypesContext(() => this.tsParseType());
  ...
  reportReservedArrowTypeParam(node) {
    var _node$extra2;
    if (node.params.length === 1 && !node.params[0].budget && !((_node$extra2 = node.extra) != null && _node$extra2.trailingComma) && this.getPluginOption("typescript", "disallowAmbiguousJSXLike")) {
