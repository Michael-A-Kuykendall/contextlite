...
const (
	...
	FeatureAdvancedoptimization      = "advanced_optimization"
...
// ValidateAdvancedoptimization checks if advanced optimization features are available
func (fg *FeatureGate) ValidateAdvancedoptimization() error {
	return fg.RequireProfessional("advanced optimization optimization")
}
...
func (fg *FeatureGate) GetLicenseStatus() map[string]interface{} {
	...
	return map[string]interface{}{
		...
		"features": map[string]bool{
			...
			"advanced_optimization":       fg.IsFeatureAvailable(FeatureAdvancedoptimization),
